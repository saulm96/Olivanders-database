...
CREATE TABLE IF NOT EXISTS `Olivanders`.`wands` (
  ...
  `length` INT NOT NULL,
  PRIMARY KEY (`wand_id`),
  INDEX `idx_core_id` (`core_id` ASC),
  INDEX `idx_wood_id` (`wood_id` ASC),
  INDEX `idx_wandmaker_id` (`wandmaker_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Olivanders`.`Transfers` (
  ...
  `wandmaker_id` INT UNSIGNED NULL,
  `user_id` INT UNSIGNED NOT NULL,
  `wand_id` INT UNSIGNED NOT NULL,
  `price` INT NULL,
  `date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`transfer_id`),
  INDEX `idx_transfer_wand_id` (`wand_id` ASC),
  INDEX `idx_transfer_user_id` (`user_id` ASC),
  INDEX `idx_transfer_wandmaker_id` (`wandmaker_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Olivanders`.`wood_has_language` (
  ...
  INDEX `idx_language_id` (`language_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Olivanders`.`core_has_language` (
  ...
  INDEX `idx_language_core_id` (`language_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Olivanders`.`wandmaker_has_language` (
  ...
  INDEX `idx_wandmaker_language_id` (`language_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Olivanders`.`wand_has_language` (
    ...
    INDEX `fk_wand_id_idx` (`wand_id` ASC),
...
-- -----------------------------------------------------
-- Other Tables and their corrections included similarly
-- -----------------------------------------------------
